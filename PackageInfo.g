#############################################################################
##  
##  PackageInfo.g for the package `k-Points'                    Mohamed Barakat
##  
...
#
PackageName := "k-Points",

##  This may be used by a default banner or on a Web page, should fit on
##  one line.
Subtitle := "A homalg based package to construct algebraic solutions",

##  See '?Extending: Version Numbers' in GAP help for an explanation
##  of valid version numbers. For an automatic package distribution update
##  you must provide a new version number even after small changes.
Version := Maximum( [
  "2011.06.11", ## Mohamed's version
...
# 
ArchiveURL := Concatenation( "http://homalg.math.rwth-aachen.de/~barakat/homalg-project/k-Points/k-Points-", ~.Version ),
...
#
README_URL := 
  "http://homalg.math.rwth-aachen.de/~barakat/homalg-project/k-Points/README.k-Points",
PackageInfoURL := 
  "http://homalg.math.rwth-aachen.de/~barakat/homalg-project/k-Points/PackageInfo.g",
...
PackageDoc := rec(
  ...
  LongTitle := "A homalg based package to construct algebraic solutions",
...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "GradedModules", ">= 2011.05.20" ], [ "GAPDoc", ">= 1.0" ] ],
